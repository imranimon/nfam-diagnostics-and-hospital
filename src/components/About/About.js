        ...
        <div className="text-center p-5 d-flex justify-content-center">
            <div>
                <Row className="w-100">
                    ...
                    <p className="mt-2">The reputation of Square Hospital is the result of quality clinical outcome and comprehensive care, made achievable through world class integrated healthcare facilities by highly trained professionals. Thus, Square Hospitals strives to meet patients’ standards through quality healthcare and making a difference in their lives.</p>
                ...
                <Row className="mt-5 w-100">
                    ...
                    <ListGroup className="mt-2">
                        <ListGroup.Item>
                            <span className="fw-bold fst-italic">Best Child Specialist:</span> Department of Pediatrics II (Pediatric Nephrology, Gastroenterology, and Endocrinology) at University Hospital Essen provides care for children and adolescents suffering from diseases affecting their kidney, urinary system, gastrointestinal tract, pancreas, biliary tract, liver, and endocrinal glands as well as nutritional disorders.
                        </ListGroup.Item>
                        <ListGroup.Item>
